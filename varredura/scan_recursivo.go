...
func main() {
	diretorioParaScanear := "/home/farnetani/cursos/nextjs"
	folders, files := scan_recursive(diretorioParaScanear, []string{".git", "/.git", "/.git/", ".gitignore", ".DS_Store", ".idea", "/.idea/", "/.idea"})
